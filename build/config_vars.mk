...
shared_build =
AP_LIBS = /home/centos/Desktop/xamin/httpd-2.2.22/srclib/pcre/libpcre.la /home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr-util/libaprutil-1.la /home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr-util/xml/expat/libexpat.la /home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr/libapr-1.la -lrt -lcrypt -lpthread
AP_BUILD_SRCLIB_DIRS = apr apr-util pcre
AP_CLEAN_SRCLIB_DIRS = apr-util apr pcre
abs_srcdir = /home/centos/Desktop/xamin/httpd-2.2.22
...
EXTRA_LDFLAGS =
EXTRA_LIBS = -lm
EXTRA_INCLUDES = -I$(top_builddir)/srclib/pcre -I. -I$(top_srcdir)/os/$(OS_DIR) -I$(top_srcdir)/server/mpm/$(MPM_SUBDIR_NAME) -I$(top_srcdir)/modules/http -I$(top_srcdir)/modules/filters -I$(top_srcdir)/modules/proxy -I$(top_srcdir)/include -I$(top_srcdir)/modules/generators -I$(top_srcdir)/modules/mappers -I$(top_srcdir)/modules/database -I/home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr/include -I/home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr-util/include -I/home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr-util/xml/expat/lib -I$(top_srcdir)/modules/proxy/../generators -I$(top_srcdir)/modules/ssl -I$(top_srcdir)/modules/dav/main
LIBTOOL = /home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr/libtool $(LTFLAGS)
SHELL = /bin/sh
RSYNC = /usr/bin/rsync
...
APR_INCLUDEDIR = /home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr/include
APR_VERSION = 1.4.5
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /home/centos/Desktop/xamin/httpd-2.2.22/srclib/apr-util/include
APU_VERSION = 1.4.1
